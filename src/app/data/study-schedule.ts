...
// Array com o plano de estudos detalhado (v15 - Início em 06/10).
export const studyDays: StudyDay[] = [
    ...
    },
    {
        ...
        focus: "⚡ Maratona de Sábado! Finalizando o C.06 de Next.js e dando os primeiros passos em TypeScript (C.07).",
        isIntensive: true,
    },
    {
        id: "dom1210",
        ...
        focus: "⚡ Domingo Especial! Finalizando TypeScript (C.07) e começando a jornada de React com TypeScript (C.08).",
        isIntensive: true,
    },
    {
        id: "seg1310",
    ...
    },
    {
        ...
        focus: "⚡ Sábado de Progresso! Dando um grande avanço no C.08 e começando a dominar o Tailwind CSS (C.09).",
        isIntensive: true,
    },
    {
        id: "dom1910",
